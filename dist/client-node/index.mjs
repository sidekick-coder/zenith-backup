...
class p extends n {
  async onLoad() {
    ...
    }), o.auto(/* @__PURE__ */ Object.assign({ "../pages/plans/[id].vue": () => import("./_id_-CXXlBC9t.mjs"), "../pages/plans/index.vue": () => import("./index-BnFTU2tV.mjs"), "../pages/triggers/index.vue": () => import("./index-D9OJ2yXe.mjs") }), {
      strip: ["pages"],
