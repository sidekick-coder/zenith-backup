...
class OE extends Po {
  async onLoad() {
    ...
    }), zi.auto(/* @__PURE__ */ Object.assign({ "../pages/plans/[id].vue": () => import("./_id_-BvtvdShi.mjs"), "../pages/plans/index.vue": () => import("./index-BCg3_2pk.mjs"), "../pages/triggers/index.vue": () => import("./index-uVgkdpC6.mjs") }), {
      strip: ["pages"],
