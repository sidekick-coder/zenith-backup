...
export default class ResticStrategy extends composeWith(
    ...
    static {
        this.section('repository', {
            ...
            description: 'Settings related to the Restic repository where backups will be stored.',
        })
        ...
        this.field('repository', {
            ...
            label: 'Repository',
            description: 'File path or URL to the Restic repository.',
        })
        ...
        this.field('password', {
            ...
            description: 'Password for encrypting/decrypting the Restic repository.',
        })

        this.section('backup', {
            title: 'Backup',
            description: 'Settings related to the files and directories to be backed up.',
        })
        ...
        this.field('paths', {
            ...
            section_id: 'backup',
            label: 'Paths',
            description: 'List of file and directory paths to include in the backup.',
            placeholder: 'Absolute path to file or directory2 (e.g., /var/www/html)',
        })
        ...
        this.field('backup_flags', {
            ...
            section_id: 'backup',
            label: 'Backup Flags',
            description: 'Additional Restic backup command flags (e.g., --exclude /path/to/exclude).',
        })

        this.section('cleanup', {
            title: 'Cleanup',
            description: 'Settings related to automatic cleanup of old snapshots.',
        })
        ...
        this.field('forget_enabled', {
            ...
            section_id: 'cleanup',
            label: 'Enable Forget',
            description: 'Enable automatic cleanup of old snapshots after backup.',
            clearable: true,
            options: [
                {
                    value: true,
        ...
        this.field('forget_flags', {
            ...
            section_id: 'cleanup',
            label: 'Forget Flags',
            description: 'Restic forget command flags (e.g., --keep-daily 7 --keep-weekly 4).',
        })
    }
