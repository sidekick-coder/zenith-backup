...
var SnapshotRestoreDialog_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const { handleSubmit, values, setValues } = useForm({
			validationSchema: toTypedSchema(v.object({ restore_folder: v.optional(v.string(), "") })),
			initialValues: { restore_folder: "" }
		});
		const onSubmit = handleSubmit(async (payload) => {
			loading.value = true;
			const data = { snapshotId: props.snapshot.id };
			if (payload.restore_folder) data.restore_folder = payload.restore_folder;
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(unref(Dialog), mergeProps({
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(unref(DialogContent), null, {
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								_push(ssrRenderComponent(unref(DialogHeader), null, {
									default: withCtx((_, _push, _parent, _scopeId) => {
										if (_push) {
											_push(ssrRenderComponent(unref(DialogTitle), null, {
												default: withCtx((_, _push, _parent, _scopeId) => {
													if (_push) _push(`${ssrInterpolate(_ctx.$t("Restore Snapshot"))}`);
													else return [createTextVNode(toDisplayString(_ctx.$t("Restore Snapshot")), 1)];
												}),
												_: 1
											}, _parent, _scopeId));
											_push(ssrRenderComponent(unref(DialogDescription), null, {
												default: withCtx((_, _push, _parent, _scopeId) => {
													if (_push) _push(`${ssrInterpolate(_ctx.$t("Restore snapshot :0 to a specific location.", [__props.snapshot.id]))}`);
													else return [createTextVNode(toDisplayString(_ctx.$t("Restore snapshot :0 to a specific location.", [__props.snapshot.id])), 1)];
												}),
												_: 1
											}, _parent, _scopeId));
										} else return [createVNode(unref(DialogTitle), null, {
											default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Restore Snapshot")), 1)]),
											_: 1
										}), createVNode(unref(DialogDescription), null, {
											default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Restore snapshot :0 to a specific location.", [__props.snapshot.id])), 1)]),
											_: 1
										})];
									}),
									_: 1
								}, _parent, _scopeId));
								_push(`<form${_scopeId}><div class="space-y-4"${_scopeId}>`);
									...
									default: withCtx((_, _push, _parent, _scopeId) => {
										if (_push) {
											_push(ssrRenderComponent(Button, {
												...
												default: withCtx((_, _push, _parent, _scopeId) => {
													if (_push) _push(`${ssrInterpolate(_ctx.$t("Cancel"))}`);
													else return [createTextVNode(toDisplayString(_ctx.$t("Cancel")), 1)];
												}),
												_: 1
											}, _parent, _scopeId));
											_push(ssrRenderComponent(Button, {
												...
												default: withCtx((_, _push, _parent, _scopeId) => {
													if (_push) _push(`${ssrInterpolate(_ctx.$t("Restore"))}`);
													else return [createTextVNode(toDisplayString(_ctx.$t("Restore")), 1)];
												}),
												_: 1
											}, _parent, _scopeId));
											...
											default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Cancel")), 1)]),
											_: 1
										}), createVNode(Button, {
											type: "submit",
											loading: loading.value
										}, {
											default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Restore")), 1)]),
											_: 1
										}, 8, ["loading"])];
									}),
									_: 1
								...
								_push(`</form>`);
							} else return [createVNode(unref(DialogHeader), null, {
								...
								_: 1
							}), createVNode("form", { onSubmit: withModifiers(unref(onSubmit), ["prevent"]) }, [createVNode("div", { class: "space-y-4" }, [createVNode(FormTextField, {
								name: "restore_folder",
								label: _ctx.$t("Restore Folder"),
								placeholder: _ctx.$t("Leave empty to restore to original location"),
								hint: _ctx.$t("Optional: Specify a custom folder to restore the snapshot to")
					...
					else return [createVNode(unref(DialogContent), null, {
						default: withCtx(() => [createVNode(unref(DialogHeader), null, {
							default: withCtx(() => [createVNode(unref(DialogTitle), null, {
								default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Restore Snapshot")), 1)]),
								_: 1
							}), createVNode(unref(DialogDescription), null, {
...
//#endregion
//#region modules/mod/client/components/SnapshotRestoreDialog.vue
var _sfc_setup$1 = SnapshotRestoreDialog_vue_vue_type_script_setup_true_lang_default.setup;
SnapshotRestoreDialog_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
...
var SnapshotTable_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
	...
	setup(__props) {
		...
		async function load() {
			...
			snapshots.value = (response.items || []).map((item) => new Snapshot(item));
			setTimeout(() => {
				loading.value = false;
			}, 500);
		}
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									...
									_push(ssrRenderComponent(unref(CardTitle), null, {
										default: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`${ssrInterpolate(_ctx.$t("Snapshots"))}`);
											else return [createTextVNode(toDisplayString(_ctx.$t("Snapshots")), 1)];
										}),
										_: 1
									}, _parent, _scopeId));
									_push(ssrRenderComponent(unref(CardDescription), null, {
										default: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`${ssrInterpolate(_ctx.$t("View and manage snapshots for this plan."))}`);
											else return [createTextVNode(toDisplayString(_ctx.$t("View and manage snapshots for this plan.")), 1)];
										}),
										_: 1
									}, _parent, _scopeId));
									_push(`</div>`);
									...
									_push(`</div>`);
								} else return [createVNode("div", { class: "flex items-center justify-between" }, [createVNode("div", null, [createVNode(unref(CardTitle), null, {
									default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Snapshots")), 1)]),
									_: 1
								}), createVNode(unref(CardDescription), null, {
									default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("View and manage snapshots for this plan.")), 1)]),
									_: 1
								})]), createVNode(Button, {
									variant: "outline",
									onClick: load
						...
						_push(ssrRenderComponent(unref(CardContent), null, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									if (inspect.value) _push(ssrRenderComponent(ObjectInspect, {
										...
										default: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`<div class="hidden"${_scopeId}></div>`);
											else return [createVNode("div", { class: "hidden" })];
										}),
										_: 1
									}, _parent, _scopeId));
									else _push(`<!---->`);
										...
										"row-actions": withCtx(({ row }, _push, _parent, _scopeId) => {
											if (_push) {
												...
												_push(ssrRenderComponent(AlertButton, {
													...
													default: withCtx((_, _push, _parent, _scopeId) => {
														if (_push) _push(ssrRenderComponent(Icon, { name: "TimerReset" }, null, _parent, _scopeId));
														else return [createVNode(Icon, { name: "TimerReset" })];
													}),
													_: 2
												}, _parent, _scopeId));
												_push(ssrRenderComponent(AlertButton, {
												...
												_push(ssrRenderComponent(DropdownMenu, null, {
													default: withCtx((_, _push, _parent, _scopeId) => {
														if (_push) {
															_push(ssrRenderComponent(DropdownMenuTrigger, { "as-child": "" }, {
																default: withCtx((_, _push, _parent, _scopeId) => {
																	if (_push) _push(ssrRenderComponent(Button, {
																		...
																		default: withCtx((_, _push, _parent, _scopeId) => {
																			if (_push) {
																				_push(`<span class="sr-only"${_scopeId}>${ssrInterpolate(_ctx.$t("More"))}</span>`);
																				_push(ssrRenderComponent(Icon, {
																					name: "MoreVertical",
																					class: "w-3 h-3 sm:w-4 sm:h-4"
																				}, null, _parent, _scopeId));
																			} else return [createVNode("span", { class: "sr-only" }, toDisplayString(_ctx.$t("More")), 1), createVNode(Icon, {
																				name: "MoreVertical",
																				class: "w-3 h-3 sm:w-4 sm:h-4"
																			})];
																		}),
																		...
																		default: withCtx(() => [createVNode("span", { class: "sr-only" }, toDisplayString(_ctx.$t("More")), 1), createVNode(Icon, {
																			name: "MoreVertical",
																			class: "w-3 h-3 sm:w-4 sm:h-4"
																		})]),
																		_: 1
															...
															_push(ssrRenderComponent(DropdownMenuContent, { class: "max-h-60 overflow-y-auto" }, {
																default: withCtx((_, _push, _parent, _scopeId) => {
																	if (_push) {
																		_push(ssrRenderComponent(DropdownMenuItem, {
																			class: "cursor-pointer",
																			onClick: ($event) => inspect.value = row.metadata
																		}, {
																			default: withCtx((_, _push, _parent, _scopeId) => {
																				if (_push) _push(`${ssrInterpolate(_ctx.$t("Metadata"))}`);
																				else return [createTextVNode(toDisplayString(_ctx.$t("Metadata")), 1)];
																			}),
																			_: 2
																		}, _parent, _scopeId));
																		_push(ssrRenderComponent(DropdownMenuItem, {
																	...
																	} else return [createVNode(DropdownMenuItem, {
																		class: "cursor-pointer",
																		onClick: ($event) => inspect.value = row.metadata
																	}, {
																		default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Metadata")), 1)]),
																		_: 1
																	}, 8, ["onClick"]), createVNode(DropdownMenuItem, {
																		class: "cursor-pointer",
																		onClick: ($event) => inspect.value = row.data
																	}, {
															...
															default: withCtx(() => [createVNode(DropdownMenuItem, {
																class: "cursor-pointer",
																onClick: ($event) => inspect.value = row.metadata
															}, {
																default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Metadata")), 1)]),
												...
												_push(`</div>`);
											} else return [createVNode("div", { class: "flex items-center gap-2 justify-end" }, [
												createVNode(AlertButton, {
													...
													default: withCtx(() => [createVNode(Icon, { name: "TimerReset" })]),
													_: 1
												}, 8, [
													"fetch",
													"tooltip",
								...
								} else return [inspect.value ? (openBlock(), createBlock(ObjectInspect, {
									key: 0,
									"model-value": inspect.value,
									open: true,
									"onUpdate:open": (val) => {
									...
									default: withCtx(() => [createVNode("div", { class: "hidden" })]),
									_: 1
								}, 8, ["model-value", "onUpdate:open"])) : createCommentVNode("", true), createVNode(DataTable, {
									rows: snapshots.value,
									columns: unref(columns),
									loading: loading.value
								}, {
									"row-actions": withCtx(({ row }) => [createVNode("div", { class: "flex items-center gap-2 justify-end" }, [
										createVNode(AlertButton, {
											variant: "ghost",
											size: "sm",
											"fetch-method": "POST",
						...
						default: withCtx(() => [createVNode("div", { class: "flex items-center justify-between" }, [createVNode("div", null, [createVNode(unref(CardTitle), null, {
							default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Snapshots")), 1)]),
							_: 1
						}), createVNode(unref(CardDescription), null, {
							default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("View and manage snapshots for this plan.")), 1)]),
						...
						default: withCtx(() => [inspect.value ? (openBlock(), createBlock(ObjectInspect, {
							key: 0,
							"model-value": inspect.value,
							open: true,
							"onUpdate:open": (val) => {
...
//#endregion
//#region modules/mod/client/components/SnapshotTable.vue
var _sfc_setup = SnapshotTable_vue_vue_type_script_setup_true_lang_default.setup;
SnapshotTable_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("modules/mod/client/components/SnapshotTable.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var SnapshotTable_default = SnapshotTable_vue_vue_type_script_setup_true_lang_default;
//#endregion
export { SnapshotTable_default as default };
